export const NAV_ITEMS = [
  ...
  { to: '/areas', label: '片区与责任人', icon: '🗺️', title: '片区与责任人管理', subtitle: '片区下挂监测点与责任人, 归属变动全程留痕' },
  { to: '/stations', label: '监测点台账', icon: '📍', title: '监测点台账', subtitle: '维护监测点档案、点位信息、片区归属与运行状态' },
  ...
  { to: '/query', label: '数据查询', icon: '🔍', title: '数据查询', subtitle: '多条件检索、按片区/责任人聚合统计与结果导出' }
]
